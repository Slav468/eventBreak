...
function initSliders() {
  if (document.querySelector("#slider-places-theme")) {
    new Swiper("#slider-places-theme", {
  ...
  if (document.querySelector("#slider-places-any")) {
    new Swiper("#slider-places-any", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Navigation],
  ...
  if (document.querySelector("#slider-example")) {
    new Swiper("#slider-example", {
...
function initGallery() {
  if (document.querySelector("[data-fls-gallery]")) {
    const all = document.querySelectorAll("[data-fls-gallery]");
    all.forEach((el) => {
      new lightGallery(el, {
